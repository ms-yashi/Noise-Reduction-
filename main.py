...
image = cv2.imread("D:\Day 20 noise reduction\images\image1.jpg")
cv2.imshow("Original",image)

gray_Image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
cv2.imshow("Gray Image", gray_Image)
canny_edge = cv2.Canny(gray_Image, 70, 100)
...
image = cv2.putText(image, Text, (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2 , cv2.LINE_AA)
